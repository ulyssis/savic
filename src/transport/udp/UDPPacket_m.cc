...
bool UDPPacket::getInbuffer() const
{
    return inbuffer_var;
}

void UDPPacket::setInbuffer(bool inbuffer)
{
...
int UDPPacketDescriptor::findField(void *object, const char *fieldName) const
{
    ...
    if (fieldName[0]=='i' && strcmp(fieldName, "inbuffer")==0) return base+2;
...
std::string UDPPacketDescriptor::getFieldAsString(void *object, int field, int i) const
{
    ...
    switch (field) {
        ...
        case 2: return bool2string(pp->getInbuffer());
        default: return "";
    }
}
...
bool UDPPacketDescriptor::setFieldAsString(void *object, int field, int i, const char *value) const
{
    ...
    switch (field) {
        ...
        case 2: pp->setInbuffer(string2bool(value)); return true;
