...
double IPv4ControlInfo_Base::getTransmitterPower() const
{
    return transmitterPower_var;
}

void IPv4ControlInfo_Base::setTransmitterPower(double transmitterPower)
{
...
int IPv4ControlInfoDescriptor::findField(void *object, const char *fieldName) const
{
    ...
    if (fieldName[0]=='t' && strcmp(fieldName, "transmitterPower")==0) return base+14;
...
std::string IPv4ControlInfoDescriptor::getFieldAsString(void *object, int field, int i) const
{
    ...
    switch (field) {
        ...
        case 14: return double2string(pp->getTransmitterPower());
        default: return "";
    }
}
...
bool IPv4ControlInfoDescriptor::setFieldAsString(void *object, int field, int i, const char *value) const
{
    ...
    switch (field) {
        ...
        case 14: pp->setTransmitterPower(string2double(value)); return true;
...
double IPv4RoutingDecision::getTransmitterPower() const
{
    return transmitterPower_var;
}

void IPv4RoutingDecision::setTransmitterPower(double transmitterPower)
{
    this->transmitterPower_var = transmitterPower;
}
...
int IPv4RoutingDecisionDescriptor::findField(void *object, const char *fieldName) const
{
    ...
    if (fieldName[0]=='t' && strcmp(fieldName, "transmitterPower")==0) return base+2;
    return basedesc ? basedesc->findField(object, fieldName) : -1;
}
...
std::string IPv4RoutingDecisionDescriptor::getFieldAsString(void *object, int field, int i) const
{
    ...
    switch (field) {
        ...
        case 2: return double2string(pp->getTransmitterPower());
        default: return "";
    }
}
...
bool IPv4RoutingDecisionDescriptor::setFieldAsString(void *object, int field, int i, const char *value) const
{
    ...
    switch (field) {
        ...
        case 2: pp->setTransmitterPower(string2double(value)); return true;
        default: return false;
    }
}
