...
#include <list>
typedef std::list<IPv4Address> DeadendList;
typedef std::list<IPv4Address> PathList; 
typedef std::list<IPv4Address> PathListSear; 
typedef std::list<simtime_t> timeList; 
typedef std::pair<IPv4Address,simtime_t> bufferRecord;
typedef std::list<bufferRecord> bufferHistory;
 ...
 *     PathList pathList;
 *     PathListSear pathListSear;
 *     
 *     timeList arrivalTimeList;
 *     int numAccessedNodes;
 *     simtime_t startTime;
 *     
 *    
 * 
...
class INET_API IPv4Datagram_Base : public ::cPacket
{
  protected:
    ...
    PathListSear pathListSear_var;
    timeList arrivalTimeList_var;
    int numAccessedNodes_var;
  ...
  public:
    ...
    virtual const DeadendList& getDeadendList() const {return const_cast<IPv4Datagram_Base*>(this)->getDeadendList();}
    virtual void setDeadendList(const DeadendList& deadendList);
    virtual PathList& getPathList();
    virtual const PathList& getPathList() const {return const_cast<IPv4Datagram_Base*>(this)->getPathList();}
    virtual void setPathList(const PathList& pathList);
    virtual PathListSear& getPathListSear();
    virtual const PathListSear& getPathListSear() const {return const_cast<IPv4Datagram_Base*>(this)->getPathListSear();}
    virtual void setPathListSear(const PathListSear& pathListSear);
    virtual timeList& getArrivalTimeList();
    virtual const timeList& getArrivalTimeList() const {return const_cast<IPv4Datagram_Base*>(this)->getArrivalTimeList();}
    virtual void setArrivalTimeList(const timeList& arrivalTimeList);
    virtual int getNumAccessedNodes() const;
    virtual void setNumAccessedNodes(int numAccessedNodes);
