...
void IPv4Datagram_Base::copy(const IPv4Datagram_Base& other)
{
    ...
    this->pathListSear_var = other.pathListSear_var;
    this->arrivalTimeList_var = other.arrivalTimeList_var;
    this->numAccessedNodes_var = other.numAccessedNodes_var;
...
void IPv4Datagram_Base::parsimPack(cCommBuffer *b)
{
    ...
    doPacking(b,this->pathListSear_var);
    doPacking(b,this->arrivalTimeList_var);
    doPacking(b,this->numAccessedNodes_var);
...
void IPv4Datagram_Base::parsimUnpack(cCommBuffer *b)
{
    ...
    doUnpacking(b,this->pathListSear_var);
    doUnpacking(b,this->arrivalTimeList_var);
    doUnpacking(b,this->numAccessedNodes_var);
...
DeadendList& IPv4Datagram_Base::getDeadendList()
{
    return deadendList_var;
}

void IPv4Datagram_Base::setDeadendList(const DeadendList& deadendList)
{
    this->deadendList_var = deadendList;
}

PathList& IPv4Datagram_Base::getPathList()
{
    return pathList_var;
}

void IPv4Datagram_Base::setPathList(const PathList& pathList)
{
    this->pathList_var = pathList;
}

PathListSear& IPv4Datagram_Base::getPathListSear()
{
    return pathListSear_var;
}

void IPv4Datagram_Base::setPathListSear(const PathListSear& pathListSear)
{
    this->pathListSear_var = pathListSear;
}

timeList& IPv4Datagram_Base::getArrivalTimeList()
{
    return arrivalTimeList_var;
}

void IPv4Datagram_Base::setArrivalTimeList(const timeList& arrivalTimeList)
{
    this->arrivalTimeList_var = arrivalTimeList;
}

int IPv4Datagram_Base::getNumAccessedNodes() const
{
    return numAccessedNodes_var;
}

void IPv4Datagram_Base::setNumAccessedNodes(int numAccessedNodes)
{
    this->numAccessedNodes_var = numAccessedNodes;
}

simtime_t IPv4Datagram_Base::getStartTime() const
{
    return startTime_var;
}

void IPv4Datagram_Base::setStartTime(simtime_t startTime)
{
...
int IPv4DatagramDescriptor::findField(void *object, const char *fieldName) const
{
    ...
    if (fieldName[0]=='d' && strcmp(fieldName, "deadendList")==0) return base+4;
    if (fieldName[0]=='p' && strcmp(fieldName, "pathList")==0) return base+5;
    if (fieldName[0]=='p' && strcmp(fieldName, "pathListSear")==0) return base+6;
    if (fieldName[0]=='a' && strcmp(fieldName, "arrivalTimeList")==0) return base+7;
    if (fieldName[0]=='n' && strcmp(fieldName, "numAccessedNodes")==0) return base+8;
    if (fieldName[0]=='s' && strcmp(fieldName, "startTime")==0) return base+9;
    if (fieldName[0]=='t' && strcmp(fieldName, "transportProtocol")==0) return base+10;
    if (fieldName[0]=='t' && strcmp(fieldName, "timeToLive")==0) return base+11;
    if (fieldName[0]=='i' && strcmp(fieldName, "identification")==0) return base+12;
    if (fieldName[0]=='m' && strcmp(fieldName, "moreFragments")==0) return base+13;
    if (fieldName[0]=='d' && strcmp(fieldName, "dontFragment")==0) return base+14;
    if (fieldName[0]=='f' && strcmp(fieldName, "fragmentOffset")==0) return base+15;
    if (fieldName[0]=='t' && strcmp(fieldName, "typeOfService")==0) return base+16;
    if (fieldName[0]=='d' && strcmp(fieldName, "diffServCodePoint")==0) return base+17;
    if (fieldName[0]=='e' && strcmp(fieldName, "explicitCongestionNotification")==0) return base+18;
    if (fieldName[0]=='o' && strcmp(fieldName, "optionCode")==0) return base+19;
    if (fieldName[0]=='r' && strcmp(fieldName, "recordRoute")==0) return base+20;
    if (fieldName[0]=='t' && strcmp(fieldName, "timestampOption")==0) return base+21;
    if (fieldName[0]=='s' && strcmp(fieldName, "sourceRoutingOption")==0) return base+22;
    return basedesc ? basedesc->findField(object, fieldName) : -1;
}
...
std::string IPv4DatagramDescriptor::getFieldAsString(void *object, int field, int i) const
{
    ...
    switch (field) {
        ...
        case 4: {std::stringstream out; out << pp->getDeadendList(); return out.str();}
        case 5: {std::stringstream out; out << pp->getPathList(); return out.str();}
        case 6: {std::stringstream out; out << pp->getPathListSear(); return out.str();}
        case 7: {std::stringstream out; out << pp->getArrivalTimeList(); return out.str();}
        case 8: return long2string(pp->getNumAccessedNodes());
        case 9: return double2string(pp->getStartTime());
        case 10: return long2string(pp->getTransportProtocol());
        case 11: return long2string(pp->getTimeToLive());
        case 12: return long2string(pp->getIdentification());
        case 13: return bool2string(pp->getMoreFragments());
        case 14: return bool2string(pp->getDontFragment());
        case 15: return long2string(pp->getFragmentOffset());
        case 16: return ulong2string(pp->getTypeOfService());
        case 17: return long2string(pp->getDiffServCodePoint());
        case 18: return long2string(pp->getExplicitCongestionNotification());
        case 19: return long2string(pp->getOptionCode());
        case 20: {std::stringstream out; out << pp->getRecordRoute(); return out.str();}
        case 21: {std::stringstream out; out << pp->getTimestampOption(); return out.str();}
        case 22: {std::stringstream out; out << pp->getSourceRoutingOption(); return out.str();}
        default: return "";
    }
}
...
bool IPv4DatagramDescriptor::setFieldAsString(void *object, int field, int i, const char *value) const
{
    ...
    switch (field) {
        ...
        case 8: pp->setNumAccessedNodes(string2long(value)); return true;
        case 9: pp->setStartTime(string2double(value)); return true;
        case 10: pp->setTransportProtocol(string2long(value)); return true;
        case 11: pp->setTimeToLive(string2long(value)); return true;
        case 12: pp->setIdentification(string2long(value)); return true;
        case 13: pp->setMoreFragments(string2bool(value)); return true;
        case 14: pp->setDontFragment(string2bool(value)); return true;
        case 15: pp->setFragmentOffset(string2long(value)); return true;
        case 16: pp->setTypeOfService(string2ulong(value)); return true;
        case 17: pp->setDiffServCodePoint(string2long(value)); return true;
        case 18: pp->setExplicitCongestionNotification(string2long(value)); return true;
...
void *IPv4DatagramDescriptor::getFieldStructPointer(void *object, int field, int i) const
{
    ...
    switch (field) {
        ...
        case 4: return (void *)(&pp->getDeadendList()); break;
        case 5: return (void *)(&pp->getPathList()); break;
        case 6: return (void *)(&pp->getPathListSear()); break;
        case 7: return (void *)(&pp->getArrivalTimeList()); break;
