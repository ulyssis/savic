...
{
    EV << "sending down " << msg << "\n";
  //  std::cout<<"WirelessMacBase::sendDown, sending down"<<endl;
...
{
    EV << "sending up " << msg << "\n";
  //  std::cout<<"WirelessMacBase::sendUp, sending up"<<endl;
    if (msg->isPacket())
