...
double Ieee80211Frame::getTransmitterPower() const
{
    return transmitterPower_var;
}

void Ieee80211Frame::setTransmitterPower(double transmitterPower)
{
...
int Ieee80211FrameDescriptor::findField(void *object, const char *fieldName) const
{
    ...
    if (fieldName[0]=='t' && strcmp(fieldName, "transmitterPower")==0) return base+9;
...
std::string Ieee80211FrameDescriptor::getFieldAsString(void *object, int field, int i) const
{
    ...
    switch (field) {
        ...
        case 9: return double2string(pp->getTransmitterPower());
        default: return "";
    }
}
...
bool Ieee80211FrameDescriptor::setFieldAsString(void *object, int field, int i, const char *value) const
{
    ...
    switch (field) {
        ...
        case 9: pp->setTransmitterPower(string2double(value)); return true;
