...
double Ieee802Ctrl::getTransmitterPower() const
{
    return transmitterPower_var;
}

void Ieee802Ctrl::setTransmitterPower(double transmitterPower)
{
...
int Ieee802CtrlDescriptor::findField(void *object, const char *fieldName) const
{
    ...
    if (fieldName[0]=='t' && strcmp(fieldName, "transmitterPower")==0) return base+7;
...
std::string Ieee802CtrlDescriptor::getFieldAsString(void *object, int field, int i) const
{
    ...
    switch (field) {
        ...
        case 7: return double2string(pp->getTransmitterPower());
        default: return "";
    }
}
...
bool Ieee802CtrlDescriptor::setFieldAsString(void *object, int field, int i, const char *value) const
{
    ...
    switch (field) {
        ...
        case 7: pp->setTransmitterPower(string2double(value)); return true;
