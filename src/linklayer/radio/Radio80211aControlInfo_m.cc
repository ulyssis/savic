...
double Radio80211aControlInfo::getInbuffer() const
{
    return inbuffer_var;
}

void Radio80211aControlInfo::setInbuffer(double inbuffer)
{
...
int Radio80211aControlInfoDescriptor::findField(void *object, const char *fieldName) const
{
    ...
    if (fieldName[0]=='i' && strcmp(fieldName, "inbuffer")==0) return base+8;
...
std::string Radio80211aControlInfoDescriptor::getFieldAsString(void *object, int field, int i) const
{
    ...
    switch (field) {
        ...
        case 8: return double2string(pp->getInbuffer());
        default: return "";
    }
}
...
bool Radio80211aControlInfoDescriptor::setFieldAsString(void *object, int field, int i, const char *value) const
{
    ...
    switch (field) {
        ...
        case 8: pp->setInbuffer(string2double(value)); return true;
