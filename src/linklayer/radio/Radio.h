...
class INET_API Radio : public ChannelAccess, public IPowerControl
{
  ...
  public:
    ...
    virtual ~Radio();
#ifdef MULTI_CHA
    static simsignal_t ChannelDecisionSignal;
#endif
  protected:
...
#endif
#ifdef MULTI_CHA
    void notificationNeighborNewChannel(IPv4Address ip, int channelno);
    virtual void receiveSignal(cComponent *source, simsignal_t signalID, const char* l);
public:
