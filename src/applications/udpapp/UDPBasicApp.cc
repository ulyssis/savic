...
cPacket *UDPBasicApp::createPacket()
{
    ...
    //std::cout<<"UDPBasicApp::createPacket: send id: "<<payload->getId()<<", at time: "<<simTime()<<", creation time: "<<payload->getCreationTime()<<", pkt sent time:"<<payload->getSendingTime()<<endl;
    return payload;
}
...
void UDPBasicApp::handleMessage(cMessage *msg)
{
    ...
    {   //std::cout<<"UDPBasicApp::handleMessage, isselfmsg, simtime: "<<simTime()<<endl;
